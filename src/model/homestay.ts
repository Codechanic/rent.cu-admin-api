...
export class HomeStay {
  ...
  acommodation: AccommodationType | null;

  @ManyToOne(() => LocationType, (location: LocationType) => location.homestays, { onDelete: 'SET NULL', onUpdate: 'RESTRICT' })
  ...
  @ManyToOne(() => HomeStayChain, (homeStayChain: HomeStayChain) => homeStayChain.homestays, { onDelete: 'RESTRICT', onUpdate: 'RESTRICT' })
  ...
  @OneToMany(() => HomeStayPrice, (homeStayPrice: HomeStayPrice) => homeStayPrice.homestay, { onDelete: 'RESTRICT', onUpdate: 'RESTRICT' })
  ...
  homestayFreeservicess: FreeService[];
  ...
  homestayNotoffereds: NotOffered[];
